...
Un sistema di valutazione personale, separato dal punteggio TMDB (che resta a stelle). L'utente assegna un voto da 0 a 5 popcorn a film e serie che ha guardato, e può filtrare la libreria "Watched" per voto.
...
- Nella pagina Watched, accanto a ricerca / preferiti / dimensione griglia, si aggiunge un filtro "Voto": scelta rapida tra Tutti, 5, 4,5, 4, 3,5, 3, 2,5, 2, 1,5, 1, 0,5, 0 e "Non votati", più ordinamento per voto (dal più alto).
